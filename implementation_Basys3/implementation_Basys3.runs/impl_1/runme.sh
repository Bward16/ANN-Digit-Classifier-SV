...
HD_PWD='E:/Seth stuff/to_appease_the_haters/CSC570ComputationalNeuroscience/implementation_Basys3/implementation_Basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_net.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neural_net.tcl -notrace
